...
# myStocks
## get data
get stock prices of 7 China A-share companies and CSI 300 Index using `tidyquant` package
...
## stock prices trend
plot close price trend of all stocks and CSI 300 index from `2015-01-01` to `2020-09-30`
